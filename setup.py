...
async def run_agent(
        ...
        try:
            ...
            try:
                ...
                if isinstance(raw, dict):
                    ...
                    result_text = (
                        str(raw) if raw
                        else f"Completed {ok}/{total} steps on your desktop."
                    )
    ...
    ctx_part = ("\\nContext: " + str(body.context)) if body.context else ""
    messages = [
        {"role": "system", "content": system_prompt},
        {"role": "user",   "content": "Task: " + task_text + ctx_part},
    ]
    try:
        ...
        while True:
            try:
                ...
                if msg_type == "ping":
                    ...
                    log.debug("Unknown msg type user=%s: %s", user_id, msg_type)
