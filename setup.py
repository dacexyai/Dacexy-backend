...
_agent_lines = [
    ...
    "                elif msg_type in ('result', 'task_result', 'command_result', 'screenshot_before', 'screenshot_after', 'system_info', 'error', 'voice_result', 'ocr_result', 'vision_result', 'memory_result', 'health_result', 'skill_result', 'heartbeat'):",
