...
_agent_lines = [
    ...
    "            await db.commit()",
    "            return {'id': str(task_record.id), 'task': task_text, 'status': 'completed', 'result': result_text, 'created_at': str(task_record.created_at), 'agent_version': agent_metadata.get(user_id, {}).get('version', '')}",
    ...
    "    system_prompt = 'You are Dacexy AI. The Desktop Agent is not connected. Describe step by step what you would do. Tell user to install Dacexy Desktop Agent from Settings.'",
    ...
    "        await db.commit()",
    "        return {'id': str(task_record.id), 'task': task_text, 'status': 'completed', 'result': result, 'created_at': str(task_record.created_at), 'note': 'Desktop Agent not connected.'}",
    "    except Exception as e:",
