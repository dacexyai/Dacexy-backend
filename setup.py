...
files["src/main.py"] = '''from __future__ import annotations
import logging
...
files["src/shared/__init__.py"] = ""
files["src/shared/config/__init__.py"] = ""
files["src/shared/config/settings.py"] = '''from __future__ import annotations
...
files["src/shared/security/__init__.py"] = ""
files["src/shared/security/auth.py"] = '''from __future__ import annotations
import secrets
...
def create_access_token(subject: str, extra: dict = None, expires_minutes: int = 60) -> str:
...
files["src/shared/exceptions/__init__.py"] = '''from fastapi import HTTPException
...
files["src/shared/observability/__init__.py"] = ""
files["src/shared/logging/__init__.py"] = ""
files["src/domain/__init__.py"] = ""
files["src/domain/entities/__init__.py"] = ""
files["src/application/__init__.py"] = ""
files["src/application/use_cases/__init__.py"] = ""
files["src/application/use_cases/website/__init__.py"] = ""
files["src/application/use_cases/website/website_engine.py"] = '''from __future__ import annotations
import logging
...
files["src/infrastructure/__init__.py"] = ""
files["src/infrastructure/ai_providers/__init__.py"] = ""
files["src/infrastructure/ai_providers/deepseek.py"] = '''from __future__ import annotations
import json
...
files["src/infrastructure/email/__init__.py"] = ""
files["src/infrastructure/email/email_service.py"] = '''from __future__ import annotations
import smtplib
import logging
...
class EmailService:
    ...
    def send_verification_email(self, to: str, token: str):
        ...
        self._send(to, "Verify your Dacexy account", f"<h2>Welcome to Dacexy!</h2><p>Click to verify: <a href=\\"{url}\\">Verify Email</a></p>")

    def send_password_reset(self, to: str, token: str):
        url = f"{settings.APP_BASE_URL}/reset-password?token={token}"
        self._send(to, "Reset your Dacexy password", f"<h2>Password Reset</h2><p><a href=\\"{url}\\">Reset Password</a></p>")
'''

files["src/infrastructure/cache/__init__.py"] = ""
files["src/infrastructure/cache/upstash.py"] = '''from __future__ import annotations
import logging
import httpx
from src.shared.config.settings import settings
...
files["src/infrastructure/storage/__init__.py"] = ""
files["src/infrastructure/storage/supabase_storage.py"] = '''from __future__ import annotations
import logging
import httpx
from src.shared.config.settings import settings
...
class SupabaseStorage:
    ...
    async def upload(self, path: str, content: bytes, content_type: str = "application/octet-stream"):
        if not self.url or not self.key: return None
        try:
            async with httpx.AsyncClient() as c:
                r = await c.post(f"{self.url}/storage/v1/object/{self.bucket}/{path}", headers={**self._headers, "Content-Type": content_type}, content=content, timeout=30)
...
files["src/infrastructure/persistence/__init__.py"] = ""
files["src/infrastructure/persistence/models/__init__.py"] = ""
files["src/infrastructure/persistence/repositories/__init__.py"] = ""
files["src/infrastructure/persistence/database.py"] = '''from __future__ import annotations
from sqlalchemy.ext.asyncio import create_async_engine, AsyncSession, async_sessionmaker
from src.shared.config.settings import settings

engine = create_async_engine(settings.async_database_url, pool_size=settings.DATABASE_POOL_SIZE, max_overflow=settings.DATABASE_MAX_OVERFLOW, pool_pre_ping=True, echo=False)
...
files["src/infrastructure/persistence/models/orm_models.py"] = '''from __future__ import annotations
import uuid
...
files["src/infrastructure/billing/__init__.py"] = ""
files["src/infrastructure/media/__init__.py"] = ""

files["src/interfaces/__init__.py"] = ""
files["src/interfaces/http/__init__.py"] = ""
files["src/interfaces/http/middleware/__init__.py"] = ""
files["src/interfaces/http/middleware/rate_limit.py"] = '''from __future__ import annotations
import time
...
files["src/interfaces/http/dependencies/__init__.py"] = ""
files["src/interfaces/http/dependencies/container.py"] = '''from __future__ import annotations
from src.infrastructure.ai_providers.deepseek import DeepSeekProvider
...
files["src/interfaces/http/routes/__init__.py"] = ""
